...
let accentHeight (value : float) = Reaml_Core.property "accentHeight" value
...
let clipPath' (value : string) = Reaml_Core.property "clipPath" value
...
let colorProfile' (value : string) = Reaml_Core.property "colorProfile" value
...
let overlinePosition (value : float) = Reaml_Core.property "overlinePosition" value
let overlineThickness (value : float) = Reaml_Core.property "overlineThickness" value
...
let strokeMiterlimit (value : float) = Reaml_Core.property "strokeMiterlimit" value
...
let underlinePosition (value : float) = Reaml_Core.property "underlinePosition" value
let underlineThickness (value : float) = Reaml_Core.property "underlineThickness" value
